...
from skmultilearn.dataset import save_to_arff, get_data_home, _download_single_file, _get_md5
...
class Meka(MLClassifierBase):
    ...
    def run_command(self, meka_command):
    ...
    def _run_hardcode_train_command(self):

        meka_command = "/usr/bin/java -cp \".../meka-release-1.9.5/lib/*\" meka.classifiers.multilabel.CC -t \".../meka-release-1.9.5/data/train_X.arff\" -d \"experiment1/tempclassifier\" -output-debug-info -W weka.classifiers.trees.J48"
        self.run_command(meka_command)

    def _run_hardcode_test_command(self):

        meka_command = "/usr/bin/java -cp \".../meka-release-1.9.5/lib/*\" meka.classifiers.multilabel.CC -t \".../meka-release-1.9.5/data/train_X.arff\" -T \".../meka-release-1.9.5/data/test_X.arff\" -l \"experiment1/tempclassifier\" -verbosity 5 -W weka.classifiers.trees.J48"
        self.run_command(meka_command)
        self._parse_output()
...
if __name__ == '__main__':
    ...
    # meka_classpath = download_meka()
    meka_classpath = ".../meka-release-1.9.5/lib/"
    # meka_classpath
    #
    meka = Meka(
        meka_classifier="meka.classifiers.multilabel.CC",  # Classifier Chainn
    ...
    meka._run_hardcode_train_command()
    meka._label_count = 242
    meka._instance_count = 91

    predictions = meka._run_hardcode_test_command()

    # train_arff_file = "/Users/kunyang/Documents/Eawag/envipath/meka-release-1.9.5/data/train_X.arff"
    # test_arff_file = "/Users/kunyang/Documents/Eawag/envipath/meka-release-1.9.5/data/test_X.arff"
    # dump_classifier = "experiment1/tmp_classifier"
    #
    # input_args = [
    #     '-verbosity', "0",
    #     '-split-percentage', "100",
    #     '-t', '"{}"'.format(train_arff_file),
    #     '-d', '"{}"'.format(dump_classifier),
    # ]
    # #
    # meka._run_meka_command(input_args)
    #
    # meka.classifier_dump = None
    # with open(dump_classifier, 'rb') as fp:
    #     meka.classifier_dump = fp.read()
    #
    # args = [
    #     '-l', '"{}"'.format(dump_classifier)
    # ]
    #
    # meka._run(train_arff_file + '.arff', test_arff_file + '.arff', args)
    # meka._parse_output()
